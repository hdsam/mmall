...
create table mmall_product(
    ...
    category_id int(11) not null comment '分类id,对应mmall_category主键',
    name varchar(100) not null comment '商品名称',
    subtitle varchar(200) default null comment '商品副标题',
    main_image varchar(500) default null comment '商品主图，url相对地址',
    sub_images text comment '图片地址，json格式，扩展用',
    detail text comment '商品详情',
    price decimal(20,2) not null comment '价格，单位-元，保留小数点后两位',
...
create table mmall_order_item(
    ...
    current_unit_price decimal(20,2) default null comment '生成订单时 的商品单价，单位是元，保留两位小数',
